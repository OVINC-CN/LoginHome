const mEnUS = {
  ...
  OVINCCN: 'OVINC CN',
  OVINCPortal: 'OVINC Portal',
  Portal: 'Portal',
  OVINCHomePageSecondTitle: 'Opportunity · Vision · Internet · NextGen · Creative',
  PageNotExist: 'Page Not Exist',
  loading: 'Loading...',
  UsernameRequired: 'username is required',
  NickNameRequired: 'nickname is required',
  PasswordRequired: 'password is required',
  LoginToOVINC: 'Union Login',
  Username: 'Username',
  NickName: 'NickName',
  Password: 'Password',
  Reset: 'Reset',
  ...
  deniedWontShow: 'Already denied permissions will not show here.',
  ...
  InputIPAddress: 'Input IP Address',
  IP: 'IP',
  Country: 'Country',
  Province: 'Province',
  City: 'City',
  ...
  loginAsCurrentUser: 'Quick Login',
  loginAsAnother: 'Sign in to another account',
  LoginAs: 'Login as',
  LoginAsEnd: '',
  UserPassLogin: 'Sign In by Password',
  UsernameRegexInvalid: 'Only supports character or number',
  Bind: 'Bind',
  ...
  SendVerifyCode: 'Send',
  VerifyCodeSendSuccess: 'Send Success',
  PhoneAreaRequired: 'Area required',
  PhoneNumberRequired: 'Phone required',
  PhoneVerifyRequired: 'Verify code required',
